...
vector<vector<string>> cougar_stick_axes(void){
	vector<vector<string>> cougar_stick_axs = {{"0", "X-Axis", "images/.png"},
	        			   {"1", "Y-Axis", "images/.png"},
					   {"2", "Trim Hat-Left/Right", "images/.png"},
					   {"3", "Trim Hat-Up/Down", "images/.png"}};
return cougar_stick_axs;
}

vector<vector<string>> cougar_stick_buttons(void){
	vector<vector<string>> cougar_stick_butts = {{"0", "Gun Trigger 1st Stage", "images/.png"},
