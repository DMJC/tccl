...
devices = 
   {
      ...
      d1 = --Thrustmaster Warthog Throttle
	 {
      ...
      d2 = --Thrustmaster Pendular Rudder
         {
            vendorid = 0x044f,
            productid = 0xb68f,
         },
      
      kbd0 = "/dev/input/by-id/usb-Microsoft_Natural®_Ergonomic_Keyboard_4000-event-kbd",  -- keyboard device (try to find a suitable device by listing input devices by typing 'ls /dev/input/by-id/' )
   }
...
-- Warthog Throttle Left Axis
function d1_a2_event(value)
       send_axis_event(0, 2, value)
end

-- Warthog Throttle Right Axis
function d1_a3_event(value)
       send_axis_event(0, 3, value)
end

-- Rudder Pedals Left Right
function d2_a2_event(value)
       send_axis_event(0, 4, value)
end
-- Rudder Pedals Toe Left
function d2_a0_event(value)
       send_axis_event(0, 5, value)
end

-- Rudder Pedals Toe Right
function d2_a1_event(value)
